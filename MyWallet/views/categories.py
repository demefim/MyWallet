...
from MyWallet.forms import CategoryAssignFormset
from MyWallet.lib import last_day_of_month
from MyWallet.models import Account, Category, Split


class CategoryIndex(LoginRequiredMixin, generic.ListView):
    template_name = 'MyWallet/category_index.html'
    model = Category
...
class CategoryByMonth(LoginRequiredMixin, generic.TemplateView):
    template_name = 'MyWallet/category_by_month.html'
...
class InactiveCategoriesView(LoginRequiredMixin, generic.ListView):
    model = Category
    template_name = 'MyWallet/inactive_categories.html'
...
def assign_categories(request):
    ...
    return render(request, 'MyWallet/category_assign.html',
