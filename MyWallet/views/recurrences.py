...
from MyWallet.forms import DepositForm, RecurringTransactionForm, TransferForm, WithdrawForm
from MyWallet.lib import last_day_of_month
from MyWallet.models import RecurringTransaction, Transaction
...
class RecurringTransactionIndex(LoginRequiredMixin, generic.ListView):
    template_name = 'MyWallet/recurring_transactions.html'
...
class DisabledRecurrencesView(LoginRequiredMixin, generic.ListView):
    template_name = 'MyWallet/disabled_recurrences.html'
